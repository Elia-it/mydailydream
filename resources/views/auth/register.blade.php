                    ...
                    <div class="row mx-0 bg-black-op">
                        ...
                        <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white invisible" data-toggle="appear" data-class="animated fadeInRight">
                            <div class="content content-full">
                                ...
                                <form method="POST" class="js-validation-signup px-30" action="{{ route('register') }}">
                                  @csrf
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <div class="custom-control custom-checkbox">
                                                <input type="hidden" class="custom-control-input" id="newsletterHidden" name="newsletter" value="0">
                                                <input type="checkbox" class="custom-control-input" id="newsletter" name="newsletter" value="1">
                                                <label class="custom-control-label" for="newsletter">Do you want receive newsletter?</label>
                                            </div>
                                        </div>
                                    </div>
