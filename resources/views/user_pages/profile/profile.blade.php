...
<html lang="en" class="no-focus">
    ...
    <body>
        ...
        -->
        <script src="assets/js/laravel.app.js"></script>
    </body>
</html> --}}
...
@section('content')
  ...
  <!-- Page Content -->
  <!-- User Info -->
  <div class="bg-image bg-image-bottom" style="background-color: blue;">
      <div class="bg-primary-dark-op py-30">
          <div class="content content-full text-center">
              <!-- Avatar -->
              <div class="mb-15">
                  <a class="img-link" href="be_pages_generic_profile.html">
                      <img class="img-avatar img-avatar96 img-avatar-thumb" src="{{asset('media/avatars/avatar2.jpg')}}" alt="">
                  </a>
              </div>
              <!-- END Avatar -->
                              ...
                              @csrf
                                <div class="row items-push">
                                    ...
                                    <div class="col-lg-7 offset-lg-1">
                                        <div class="form-group row">
                                            <div class="col-12">
                                                <label for="profile-settings-username">{{Auth::user()->first_name}}</label>
